...
original_images_dir1 = 'cityscapes/Cityscapes_train'
original_images_dir2 = 'cityscapes/Cityscapes_val'
#original_images_dir3 = 'cityscapes/Cityscapes_test'
# 设置转换后JPEG图像的保存目录
...
for filename in os.listdir(original_images_dir1):
    ...
    if filename.endswith('.png'):
        ...
        output_path1 = os.path.join(output_dir1, os.path.splitext(filename)[0] + '.jpg')
...
for filename in os.listdir(original_images_dir2):
    if filename.endswith('.png'):
        ...
        output_path2 = os.path.join(output_dir2, os.path.splitext(filename)[0] + '.jpg')
...
for filename in os.listdir(original_images_dir3):
    if filename.endswith('.png'):
        ...
        output_path3 = os.path.join(output_dir3, os.path.splitext(filename)[0] + '.jpg')
